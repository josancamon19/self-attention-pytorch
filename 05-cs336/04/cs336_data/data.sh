...
echo "Creating paloma classifier, will use 00000.warc.gz and 00001.warc.gz as negative examples"
uv run python cs336_data/leaderboard/processing/classifier.py